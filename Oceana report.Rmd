...
Fish and seafood consumption in Brazil is still incipient compared to other parts of the world. However, fisheries resources are important source of food in the poorest regions of the country and therefore are key to food security in Brazil. The Amazon region has some of the highest fish consumption in the world, reaching 169kg/capita/year in riverine communities. According to the compiled databases, sardines are the most important fish for consumption in Brazil, especially through the canned market. It is an affordable alternative to other protein sources that is consumed all over the country. Other important resources for fish and seafood consumption in the country are: croakers, tilapia, catfish, cachuma, tunas, sharks, among others. Brazil is characterized by having hundreds of commercially exploited species, especially in the small-scale sector. 
