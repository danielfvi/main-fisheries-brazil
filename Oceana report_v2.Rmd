...
6. Fishing Permits - Two sources of data. 1) Total number of registered fishers in the country from the extinct Ministry of Fisheries and Aquaculture (2003 - 2013). 2) Number of regitered fishers per state of Brazil from a study conducted during investigation against fraud in fishers insurance system (Ministério da Transparência, Fiscalização e Controladoria-Geral da União - CGU, 2017).
...
##Key messages
  ...
  * Fisheries in Brazil are mostly artisanal, with less than 5% of the registered fishers from the industrial sector
  * There is no national-level fisheries statistics since 2007
...
2. CEAGESP - CEAGESP data is trustworthy and has very little uncertainty. Data collection is done by a contracted company that controls all products entering the market daily. 
...
**Key messages**:
  * Fisheries hava high social importance for Brazil, employing millions across the entire supply chain
...
According to our databases, sardines are the most valuable species in the country. The canned sardine and tuna market is crucial for the country's economy. Seafood industries that process these and other fish have an aggregated revenue of multiple billion dollars every year. Lobsters are also highly valuable. It is the main exported species in Brazil and is captured exclusively by the artisanal fleet.  

##Conclusion

Regardless of data gaps, this study was able to gather the best information available in Brazil. The study highlighted the huge importance of fisheries for income, employment and food security in Brazil. With data from the seafood industry and seafood markets, we now have a better understanding of the main seafood products consumed in the country. With data from IBGE, we were able to highlight the importance of fish and seafood products for food security in the poorest parts of the country. Fishing licenses data helped us to better understand the distribution of fishers across the country and highlight the incredible social importance of fisheries for Brazil. Regional landings data helped us better understand the main species caught in some of the most important ports in the country. Import and export data showed the magnitude of the seafood deficit in the country, with a huge potential for aquaculture to fill this gap. 
