...
##Key messages
  ...
  * Fisheries resources are important source of food in the poorest regions of the country thus key for food security in the country
  * Fisheries in Brazil are mostly artisanal, with less than 5% of the registeres fishers from the industrial sector
...
3. MDIC - This daatbase does not contain any important source of uncertainty, since all product imported or exported are rigorously checked by the governemnt. 

4. State fisheries landings - These data have important sources of uncertainty. As with most landing data, in some states and specific years monitoring was not carried out in all landing sites in the state. In many cases, sampled catch was extrapolated to the entire fleet. However, such landings data are the most complete of the country.   

5. IBGE - This data relies on questionaires from a random household sample in each region of the country. Especially for seafood products, highest consumption rates are from isolated coastal and riverine communities. Therefore, there might be sampling biases related to this database. However, IBGE is recognized internationally for high quality research and for having robust sampling of all areas in the country. Another potential source of bias is the date of the study. The survey was done in 2008, which may not reflect fish consumption today.  

6. Fishing Permits - Although this database brings important information, there is a huge uncertainty regarding the number of fisher in the country. A huge fraud is currently being investigated by non-fishers that are registered as artisanal fishers to receive an insurance for fisheries closureperiods. According to the investigation, more than half of the insurance paid is irregular. In addition, many actual fishers do not have a fishing permit. Thus, this database is highly uncetain. 
...
**Key messages**:
  ...
  * From the main fish species consumed in Brazil, about half are from capture fisheries


Domestic consumption of fish and seafood products in Brazil is still incipient compared to other countries around the globe (around 10kg/capita/year). However, because of Brazil's large population, consumption of fish and seafood product sums up to large amounts every year. To supply the domestic market, Brazil imports over 380k tons of seafood products every year. However, with increased aquaculture production (about 770k tons in 2017), domestic supply of fish and seafood products are rising quickly. 
