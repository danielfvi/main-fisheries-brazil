...
The state of Santa Catarina is one of the main fisheries producers in the country. This state is home to the largest fisheries port in the country, concentrating most of the industrial fleet from Brazil (Figure X). Landings data fromt this state is available since 2000, although from 2014-2016 catches are underreported due to lack of funding. Yearly production from Santa Catarina (about 130k tonnes) corresponds to about 18% of the total esimated landing from capture fisheries in Brazil (about 760k tonnes).
...
The main species caught in the state accross all years are sardines, herring, croaker and skipjack tuna. Below is a table with an example of top 10 species caught in 2017 (Table X).
...
The state of Sao Paulo has a continuous data collection program dating back from 1998 (Figure X). Although this state is not the main fisheries producer in the country, landing average about 35k tonnes per year (about 5% of the total esimated landing from capture fisheries in Brazil). 2017 was the year in which data collection program covered all regions in the state, which explains increased catches during this period. 
...
The main species caught in the state accross all years were shrimps, crayfish and crabs. Below is a table with an example of top 10 species caught in 2017 (Table X). The fishing fleet from this state is mainly artisanal, with very few industrial boats. Thus, catches represnt the species captured by the artisanal fleet in this region.
...
Fisheries production in the amazon state is exclusively from riverine systems and small-scale boats. According to estimates from the state government, production has remained stable over the last decade, totaling around 200k tonnes per year (Figure X). From the estimated prodction, about 40% of the catch is for subsistance consumption of riverine communities.  
...
Domestic consumption of fish and seafood in Brazil is estimated to be around 10 kilograms per capita per year (FAO, 2014). Per capita consumption in Brazil is low relive to other countries (average of 18 kg in the world) and the World Health Organization recommendation (12 kg). However, fish and seafood consumption has been steadily increasing from 4.6 kg per capita in 1961 to about 10 kg per capita in 2014 (FAO). Because of Brazil's large population (about 200 million people), this sums up to large amounts of seafood being consumed in the country, although consumption significantly varies across regions of the country. Additionally, estimates from FAO does not account for subsistence consumption of fish, where in some regions of the Amazon can be as high as 169 kg/capita/year (Isaac et al 2015). According to estimates from the fisheries department of the Amazon state, about 80k tonnes of fish is consumed for subsistance of reverine communities (Figure X - above). 
...
##Key messages
  ...
  * There is no national-level fisheries ststistics since 2007 in the country
...
3. MDIC - This database does not contain any important source of uncertainty, since all product imported or exported are rigorously checked by the governemnt. 
...
State fisheries landings indicate that the main caught species by the industrial sector (represented by Santa Catarina state) are sardines, herring, croaker and skipjack tuna. Relative participation of each species veries yearly, with most variability in sardine catches. Such Variability is mainly caused by environmental stochasticity linked to El Nino events. Landings from the artisanal sector (represented by Sao Paulo and Parana states) indicate that the main species captured are shimps, crayfish and crabs.  
...
Despite low per capta consumption accross the country, consumption of fish in the poorest regions of the country can be very high. For example, the Amazon region has one of the highest fish consumption in the world, reaching 169kg/capta/year. Only in this state, it is estimated that about 80k tons of fish is consumed for subsistance of riverine communities.  In this study, we found that the poorest regions of the country are those that consume the most fish, which makes fisheries production crucial for food security. The North and Northeast regions are especieally important since they  have the highest fish consumption per capta in the country, while having the lowest per capta income and the largest number of registered fishers in the country. 

According to the compiled databases, sardines are the most important fish for consumption in Brazil, especially through the canned market. It is an affordable alternative to other protein sources and is consumed all over the country. Other important resources for fish and seafood consumption in the country are: croakers, tilapia, catfish, cachuma, tunas, sharks, salmon, hake, among others. From these main species consumed, tilapia and cachuma are from national aquaculture production and salmon is imported mainly from Chile. The remaining species are from domestic capture fisheries. However, these results rely on data mostly from imports, aquaculture and the industrial sector (which comprises about 30-50% of catches in the country). The remaining production is from the small-scale sector, where there is basically no information on catches. Production from the atisanal sector is mainly consumed locally, with huge social importance in the country. This sector is characterized by having hundreds of commercially exploited species, where some of  the most important species are crabs, shrimps, lobster, snappers, groupers, mullet, weakfish and snook.
