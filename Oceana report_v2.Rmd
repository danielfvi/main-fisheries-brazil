...
The state of Santa Catarina is one of the main fisheries producers in the country. This state is home to the largest fisheries port in the country, concentrating most of the industrial fleet from Brazil (Figure X). Landings data fromt his state date back from year 2000, although from 2014-2016 catches are underreported due to lack of funding. Yearly production from Santa Catarina (about 130k tonnes) corresponds to about 18% of the total esimated landing from capture fisheries in Brazil (about 760k tonnes).
...
The main species caught in the state accross all years are sardines, croaker and skipjack tuna. Below is a table with an example of top 10 species caught in 2017 (Table X).
...
Looking at historical records of the main species caught, it is possible to see the variability in catch especially of sardines (Figure X).
...
The main species caught in the state accross all years are shrimps, crayfish and crabs. Below is a table with an example of top 10 species caught in 2017 (Table X). The fishing fleet from this state is mainly artisanal, with very few industrial boats. 
...
Fisheries production in Parana state is mainly artisanal and totaled around one thousand tonnes in 2017. The main species caught in the state is shrimp, followed by crab and crayfish (Table X). This state represent overall catches from the artisanal sector in the country. Landing data is only available since 2016 for this state.  
...
Fisheries production in the amazon state is exclusively from riverine systems and small-scale boats. According to estimates from the state government, production has remained stable over the last decade, totaling around 200k tonnes per year (Figure X). From the estimated prodction, about 40% of the catch is for subsistance of riverine communities.  
...
##Key messages
  ...
  * Fisheries resources are important source of food in the poorest regions of the country thus key for food security
  * Fisheries in Brazil are mostly artisanal, with less than 5% of the registeres fishers from the industrial sector
  * There is no national-level fisheries ststistics in the country
  * Aquaculture is the fastest growing food industry in the country
